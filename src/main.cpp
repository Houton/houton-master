...
const string strMessageMagic = "houton Signed Message:\n";
...
// houton: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "houton", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "NYT Trump Goes After Senator Bob Corker, Who Bites Back";
        CTransaction txNew;
        txNew.nTime = 1507234400;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0c95ca124e716882dd452804b3ca4795f02842f38205ff199cf5489ec1b54501"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xb2, 0xd4, 0xf1 };
